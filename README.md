...
Source code for EERAD3 to compute three-jets event shapes QCD corrections up to NLO to Higgs decays into a pair of gluons and up to NLO into a bottom-antibottom pair. All files in the repository are listed in filelist.txt. Reference: Event_Shapes_in_hadronic_Higgs_decays.pdf (file in this repository).
